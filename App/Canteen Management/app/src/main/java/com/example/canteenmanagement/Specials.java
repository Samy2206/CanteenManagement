...
public class Specials extends AppCompatActivity {
    ...
    private RecyclerView recSpecial;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recSpecial = findViewById(R.id.recColdDrink);
        btnAddItem = findViewById(R.id.btnAddItem);
        recSpecial.setLayoutManager(new LinearLayoutManager(Specials.this));

        Toolbar toolbar = findViewById(R.id.toolbar);
        toolbar.setTitle("Specials");
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            recSpecial.setAdapter(adapter);
                            adapter.notifyDataSetChanged();
                        } else {
                            Toast.makeText(Specials.this, "Unable to Load Data", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    private void addItems() {
        ...
        digimgNew.setImageResource(R.drawable.special_food);
        ...
        if (digbtnAdd != null && digbtnSelect != null) {
            ...
            digbtnAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    {
                        Toast.makeText(Specials.this, "No Empty Field Allowed", Toast.LENGTH_SHORT).show();
                    }
                    else {
    ...
    private void uploadImageToFirebaseStorage(Uri imgUri, String foodName, String foodPrice, Dialog dialog) {
        if (imgUri != null) {
            ...
            StorageReference imagesRef = storageRef.child("special").child(imgUri.getLastPathSegment());
            ...
            imagesRef.putFile(imgUri)
                    .addOnSuccessListener(taskSnapshot -> {
                        ...
                        imagesRef.getDownloadUrl().addOnSuccessListener(uri -> {
                            ...
                            Toast.makeText(Specials.this, "Failed to get download URL", Toast.LENGTH_SHORT).show();
                        });
                    })
                    .addOnFailureListener(exception -> {
                        // Handle unsuccessful uploads
                        Toast.makeText(Specials.this, "Failed to upload image", Toast.LENGTH_SHORT).show();
                    });
        } else {
            // No image selected
            Toast.makeText(Specials.this, "Please select an image", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void storeDataInFirestore(String foodName, String foodPrice, String imageUrl) {
        ...
        db.collection("special")
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    Toast.makeText(Specials.this, "Item added successfully", Toast.LENGTH_SHORT).show();
                    retrieveData();
                })
                .addOnFailureListener(e -> {
                    // Handle errors
                    Toast.makeText(Specials.this, "Failed to add item", Toast.LENGTH_SHORT).show();
                });
    }
