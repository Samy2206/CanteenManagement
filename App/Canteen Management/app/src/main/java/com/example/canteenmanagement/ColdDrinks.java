...
public class ColdDrinks extends AppCompatActivity {
    ...
    private RecyclerView recColdDrinks;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recColdDrinks = findViewById(R.id.recColdDrink);
        btnAddItem = findViewById(R.id.btnAddItem);
        recColdDrinks.setLayoutManager(new LinearLayoutManager(ColdDrinks.this));

        Toolbar toolbar = findViewById(R.id.toolbar);
        toolbar.setTitle("Cold Drinks");
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            recColdDrinks.setAdapter(adapter);
                            adapter.notifyDataSetChanged();
                        } else {
                            Toast.makeText(ColdDrinks.this, "Unable to Load Data", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    private void addItems() {
        ...
        Dialog dialog = new Dialog(ColdDrinks.this);
        ...
        digimgNew.setImageResource(R.drawable.cold_drinks);
        ...
        if (digbtnAdd != null && digbtnSelect != null) {
            ...
            digbtnAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    {
                        Toast.makeText(ColdDrinks.this, "No Empty Field Allowed", Toast.LENGTH_SHORT).show();
                    }
                    else {
    ...
    private void uploadImageToFirebaseStorage(Uri imgUri, String foodName, String foodPrice, Dialog dialog) {
        if (imgUri != null) {
            ...
            StorageReference imagesRef = storageRef.child("cold_drinks").child(imgUri.getLastPathSegment());
            ...
            imagesRef.putFile(imgUri)
                    .addOnSuccessListener(taskSnapshot -> {
                        ...
                        imagesRef.getDownloadUrl().addOnSuccessListener(uri -> {
                            ...
                            Toast.makeText(ColdDrinks.this, "Failed to get download URL", Toast.LENGTH_SHORT).show();
                        });
                    })
                    .addOnFailureListener(exception -> {
                        // Handle unsuccessful uploads
                        Toast.makeText(ColdDrinks.this, "Failed to upload image", Toast.LENGTH_SHORT).show();
                    });
        } else {
            // No image selected
            Toast.makeText(ColdDrinks.this, "Please select an image", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void storeDataInFirestore(String foodName, String foodPrice, String imageUrl) {
        ...
        db.collection("ColdDrinks")
                .add(item)
                .addOnSuccessListener(documentReference -> {
                    // DocumentSnapshot added with ID: documentReference.getId()
                    Toast.makeText(ColdDrinks.this, "Item added successfully", Toast.LENGTH_SHORT).show();
                    retrieveData();
                })
                .addOnFailureListener(e -> {
                    // Handle errors
                    Toast.makeText(ColdDrinks.this, "Failed to add item", Toast.LENGTH_SHORT).show();
                });
    }
