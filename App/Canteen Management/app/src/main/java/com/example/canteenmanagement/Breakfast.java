...
public class Breakfast extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recBreakfast = findViewById(R.id.recColdDrink);
        btnAddItem = findViewById(R.id.btnAddItem);
        recBreakfast.setLayoutManager(new LinearLayoutManager(Breakfast.this));
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            recBreakfast.setAdapter(adapter);
                            adapter.notifyDataSetChanged();
                        } else {
                            Toast.makeText(Breakfast.this, "Unable to Load Data", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    private void addItems() {
        ...
        digimgNew.setImageResource(R.drawable.breakfast2);
        ...
        if (digbtnAdd != null && digbtnSelect != null) {
            ...
            digbtnAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    {
                        Toast.makeText(Breakfast.this, "No Empty Field Allowed", Toast.LENGTH_SHORT).show();
                    }
                    else {
    ...
    private void uploadImageToFirebaseStorage(Uri imgUri, String foodName, String foodPrice, Dialog dialog) {
        if (imgUri != null) {
            ...
            StorageReference imagesRef = storageRef.child("breakfast").child(imgUri.getLastPathSegment());
            ...
            imagesRef.putFile(imgUri)
                    .addOnSuccessListener(taskSnapshot -> {
                        ...
                        imagesRef.getDownloadUrl().addOnSuccessListener(uri -> {
                            ...
                            Toast.makeText(Breakfast.this, "Failed to get download URL", Toast.LENGTH_SHORT).show();
                        });
                    })
                    .addOnFailureListener(exception -> {
                        // Handle unsuccessful uploads
                        Toast.makeText(Breakfast.this, "Failed to upload image", Toast.LENGTH_SHORT).show();
                    });
        } else {
            // No image selected
            Toast.makeText(Breakfast.this, "Please select an image", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void storeDataInFirestore(String foodName, String foodPrice, String imageUrl) {
        ...
        db.collection("breakfast")
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    Toast.makeText(Breakfast.this, "Item added successfully", Toast.LENGTH_SHORT).show();
                    retrieveData();
                })
                .addOnFailureListener(e -> {
                    // Handle errors
                    Toast.makeText(Breakfast.this, "Failed to add item", Toast.LENGTH_SHORT).show();
                });
    }
