...
public class HotDrinks extends AppCompatActivity {
    ...
    private RecyclerView recHotDrinks;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recHotDrinks = findViewById(R.id.recColdDrink);
        btnAddItem = findViewById(R.id.btnAddItem);
        recHotDrinks.setLayoutManager(new LinearLayoutManager(HotDrinks.this));

        Toolbar toolbar = findViewById(R.id.toolbar);
        toolbar.setTitle("Hot Drinks");
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            recHotDrinks.setAdapter(adapter);
                            adapter.notifyDataSetChanged();
                        } else {
                            Toast.makeText(HotDrinks.this, "Unable to Load Data", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    private void addItems() {
        ...
        Dialog dialog = new Dialog(HotDrinks.this);
        ...
        digimgNew.setImageResource(R.drawable.hot_tea);
        ...
        if (digbtnAdd != null && digbtnSelect != null) {
            ...
            digbtnAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    {
                        Toast.makeText(HotDrinks.this, "No Empty Field Allowed", Toast.LENGTH_SHORT).show();
                    }
                    else {
    ...
    private void uploadImageToFirebaseStorage(Uri imgUri, String foodName, String foodPrice, Dialog dialog) {
        if (imgUri != null) {
            ...
            StorageReference imagesRef = storageRef.child("hot_drinks").child(imgUri.getLastPathSegment());
            ...
            imagesRef.putFile(imgUri)
                    .addOnSuccessListener(taskSnapshot -> {
                        ...
                        imagesRef.getDownloadUrl().addOnSuccessListener(uri -> {
                            ...
                            Toast.makeText(HotDrinks.this, "Failed to get download URL", Toast.LENGTH_SHORT).show();
                        });
                    })
                    .addOnFailureListener(exception -> {
                        // Handle unsuccessful uploads
                        Toast.makeText(HotDrinks.this, "Failed to upload image", Toast.LENGTH_SHORT).show();
                    });
        } else {
            // No image selected
            Toast.makeText(HotDrinks.this, "Please select an image", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void storeDataInFirestore(String foodName, String foodPrice, String imageUrl) {
        ...
        db.collection("HotDrinks")
                .add(item)
                .addOnSuccessListener(documentReference -> {
                    // DocumentSnapshot added with ID: documentReference.getId()
                    Toast.makeText(HotDrinks.this, "Item added successfully", Toast.LENGTH_SHORT).show();
                    retrieveData();
                })
                .addOnFailureListener(e -> {
                    // Handle errors
                    Toast.makeText(HotDrinks.this, "Failed to add item", Toast.LENGTH_SHORT).show();
                });
    }
